...
def deepmoji_multilabel_architecture(nb_classes, nb_tokens, maxlen, feature_output=False, embed_dropout_rate=0, final_dropout_rate=0, embed_l2=1E-6, return_attention=False):
    """
    ...
    if not feature_output:
        ...
        if nb_classes > 2:
            outputs = [Dense(nb_classes, activation='sigmoid', name='sigmoid')(x)]
        else:
